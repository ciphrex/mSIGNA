...
public:
    ...
    std::vector<TxOutView> getTxOutViews(const std::string& account_name = "@all", const std::string& bin_name = "@all", int spent_status_flags = TxOut::ALL, int txout_type_flags = TxOut::ALL, int tx_status_flags = Tx::ALL) const;
